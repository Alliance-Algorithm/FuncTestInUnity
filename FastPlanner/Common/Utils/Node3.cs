...
internal class Node3 : IEquatable<Node3>, IComparable<Node3>, IThreeDimensional, ICopyAble<Node3>
{
    ...
    internal float CalcF(in Node3 Target, in ESDFMap CostMap)
    {
        F = CalcH(Target, CostMap) + G;
        return F;
    }

    internal float CalcH(in Node3 Target, in ESDFMap CostMap)
    {
    ...
    private float ObsCost(in ESDFMap CostMap)
    {
        var xy = CostMap.Vector22XY(Pos);
